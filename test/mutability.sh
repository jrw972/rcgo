...
expect_error   4  "mutable mutable = mutable immutable *int"     mutability_mm_a_mip.rc 32
expect_success 5  "mutable mutable = mutable foreign int"        mutability_mm_a_mfs.rc
expect_error   6  "mutable mutable = mutable foreign *int"       mutability_mm_a_mfp.rc 32
...
expect_error   10 "mutable mutable = immutable immutable *int"   mutability_mm_a_iip.rc 32
expect_success 11 "mutable mutable = immutable foreign int"      mutability_mm_a_ifs.rc
expect_error   12 "mutable mutable = immutable foreign *int"     mutability_mm_a_ifp.rc 32
...
expect_error   16 "mutable mutable = foreign immutable *int"     mutability_mm_a_fip.rc 32
expect_success 17 "mutable mutable = foreign foreign int"        mutability_mm_a_ffs.rc
expect_error   18 "mutable mutable = foreign foreign *int"       mutability_mm_a_ffp.rc 32
...
expect_error   24 "mutable immutable = mutable foreign *int"     mutability_mi_a_mfp.rc 32
...
expect_error   30 "mutable immutable = immutable foreign *int"   mutability_mi_a_ifp.rc 32
...
expect_error   36 "mutable immutable = foreign foreign *int"     mutability_mi_a_ffp.rc 32
...
expect_error   55 "immutable mutable = mutable mutable int"      mutability_im_a_mms.rc 52
# Other cases are redundant.
expect_error   56 "foreign mutable = mutable mutable int"        mutability_fm_a_mms.rc 52
# Other cases are redundant.

expect_success 57 "*(mutable mutable) = value"                   mutability_dmm_a.rc
expect_error   58 "*(mutable immutable) = value"                 mutability_dmi_a.rc 52
expect_error   59 "*(mutable foreign) = value"                   mutability_dmf_a.rc 52

expect_success 60 "mutable mutable = *(mutable mutable)"         mutability_a_dmm.rc
expect_error   61 "mutable mutable = *(mutable immutable)"       mutability_a_dmi.rc 32
expect_error   62 "mutable mutable = *(mutable foreign)"         mutability_a_dmf.rc 32

expect_success 63 "mutable mutable = &(mutable mutable)"         mutability_a_rmm.rc
expect_error   64 "mutable mutable = &(immutable mutable)"       mutability_a_rim.rc 32
expect_error   65 "mutable mutable = &(foreign mutable)"         mutability_a_rfm.rc 32

expect_error   66 "mutable mutable = &(mutable immutable)"       mutability_a_rmi.rc 32
expect_error   67 "mutable mutable = &(immutable immutable)"     mutability_a_rii.rc 32
expect_error   68 "mutable mutable = &(foreign immutable)"       mutability_a_rfi.rc 32

expect_error   69 "mutable immutable = &(mutable foreign)"       mutability_a_rmf.rc 32
expect_error   70 "mutable immutable = &(immutable foreign)"     mutability_a_rif.rc 32
expect_error   71 "mutable immutable = &(foreign foreign)"       mutability_a_rff.rc 32

expect_success 72 "(mutable mutable). = value"                   mutability_mms_a.rc
expect_error   73 "(immutable mutable). = value"                 mutability_ims_a.rc 52
expect_error   74 "(foreign mutable). = value"                   mutability_fms_a.rc 52

expect_success 75 "mutable mutable = (mutable mutable)."         mutability_a_mms.rc
expect_error   76 "mutable mutable = (mutable immutable)."       mutability_a_mis.rc 32
expect_error   77 "mutable mutable = (mutable foreign)."         mutability_a_mfs.rc 32

expect_success 78 "(mutable mutable)[] = value"                  mutability_mmi_a.rc
expect_error   79 "(immutable mutable)[] = value"                mutability_imi_a.rc 52
expect_error   80 "(foreign mutable)[] = value"                  mutability_fmi_a.rc 52

expect_success 81 "mutable mutable = (mutable mutable)[]"        mutability_a_mmi.rc
expect_error   82 "mutable mutable = (mutable immutable)[]"      mutability_a_mii.rc 32
expect_error   83 "mutable mutable = (mutable foreign)[]"        mutability_a_mfi.rc 32

expect_error   84 "pointer in struct"                            mutability_pis.rc 32
