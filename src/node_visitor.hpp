...
struct NodeVisitor
{
  ...
  virtual void visit (BinderDecl& node) = 0;
  ...
  virtual void visit (InitializerDecl& node) = 0;
...
struct DefaultNodeVisitor : public NodeVisitor
{
  ...
  virtual void visit (BinderDecl& node);
  ...
  virtual void visit (InitializerDecl& node);
