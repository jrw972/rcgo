...
void
asm_function_comment (asm_function_t * function, const char *comment)
{
  unimplemented;
}

void
asm_function_jmp (asm_function_t * function, asm_label_t label)
{
  unimplemented;
}

void
asm_function_memclr (asm_function_t * function, size_t size)
{
  unimplemented;
}
...
void
asm_data_label (asm_data_t * data, const char *label)
{
  unimplemented;
}
