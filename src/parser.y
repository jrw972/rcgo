...
%token ACTION ACTIVATE BIND CHANGE COMPONENT CONST COPY ELSE ENUM FOR FOREIGN_KW FUNC GETTER HEAP IF INIT INSTANCE MERGE MOVE PRINTLN PULL PUSH REACTION RETURN_KW STRUCT TYPE VAR WHILE
