...
INSTANCE(int16_type_t)
INSTANCE(int32_type_t)
INSTANCE(int64_type_t)
INSTANCE(int128_type_t)
...
type_contains_pointer (const type_t* type)
{
  struct visitor : public const_type_visitor_t
  {
    ...
    void visit (const void_type_t& type)
    { }
