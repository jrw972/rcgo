...
namespace Ast
{
  ...
  struct Visitor
  {
    ...
    virtual void visit (TypeExpression& ast)
    {
      default_action (ast);
    }
    ...
    virtual void visit (Type& ast)
    {
      default_action (ast);
    }

    virtual void visit (SourceFile& ast)
    {
      default_action (ast);
    }

    virtual void default_action (Node& ast) { }
  };
  ...
  struct ConstVisitor
  {
    ...
    virtual void visit (const TypeExpression& ast)
    {
      default_action (ast);
    }
    ...
    virtual void visit (const Type& ast)
    {
      default_action (ast);
    }

    virtual void visit (const SourceFile& ast)
    {
      default_action (ast);
    }

    virtual void default_action (const Node& ast) { }
  };
