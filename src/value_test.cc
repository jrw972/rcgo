...
TEST_CASE("value::ConvertTo(Boolean -> bool)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeBoolean(true);
  REQUIRE(x->ConvertTo(&type::Bool::instance));
...
TEST_CASE("value::ConvertTo(Integer -> complex64)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(34);
...
TEST_CASE("value::ConvertTo(Complex -> complex64)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(1, 2);
  REQUIRE(x->ConvertTo(&type::Complex64::instance));
  REQUIRE(x->kind() == Value::kConstant);
  REQUIRE(x->type() == &type::Complex64::instance);
...
TEST_CASE("value::ConvertTo(Complex -> float32)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(34, 0);
  REQUIRE(x->ConvertTo(&type::Float32::instance));
  REQUIRE(x->kind() == Value::kConstant);
  REQUIRE(x->type() == &type::Float32::instance);
  REQUIRE(x->float32_value() == 34);
...
TEST_CASE("value::ConvertTo(String -> string)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeString("hello");
...
TEST_CASE("Value::Posate(Error)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::Posate(location, x, &er);
  REQUIRE(y->IsError());
}
...
TEST_CASE("Value::Posate(Integer)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(3);
  ValuePtr y = Value::Posate(location, x, &er);
...
TEST_CASE("Value::Posate(Float)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeFloat(1.5);
  ValuePtr y = Value::Posate(location, x, &er);
...
TEST_CASE("Value::Posate(int8)") {
  ...
  REQUIRE(x->ConvertTo(&type::Int8::instance));
  ValuePtr y = Value::Posate(location, x, &er);
  ValuePtr z = Value::MakeInteger(3);
...
TEST_CASE("Value::Posate(complex64)") {
  ...
  REQUIRE(x->ConvertTo(&type::Complex64::instance));
  ValuePtr y = Value::Posate(location, x, &er);
  ValuePtr z = Value::MakeComplex(1, 2);
...
TEST_CASE("Value::Negate(Error)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::Negate(location, x, &er);
  REQUIRE(y->IsError());
}
...
TEST_CASE("Value::Negate(uint8)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint8::instance));
  ValuePtr y = Value::Negate(location, x, &er);
  ValuePtr z = Value::MakeInteger(253);
  REQUIRE(z->ConvertTo(&type::Uint8::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::Negate(uint16)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint16::instance));
  ValuePtr y = Value::Negate(location, x, &er);
  ValuePtr z = Value::MakeInteger(65533);
  REQUIRE(z->ConvertTo(&type::Uint16::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::Negate(uint32)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint32::instance));
  ValuePtr y = Value::Negate(location, x, &er);
  ValuePtr z = Value::MakeInteger(4294967293);
  REQUIRE(z->ConvertTo(&type::Uint32::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::Negate(uint64)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint64::instance));
  ValuePtr y = Value::Negate(location, x, &er);
  ValuePtr z = Value::MakeInteger(18446744073709551613ul);
  REQUIRE(z->ConvertTo(&type::Uint64::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::LogicNot(Error)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::LogicNot(location, x, &er);
  REQUIRE(y->IsError());
}
...
TEST_CASE("Value::LogicNot(bool)") {
  ...
  REQUIRE(x->ConvertTo(&type::Bool::instance));
  ValuePtr y = Value::LogicNot(location, x, &er);
  ValuePtr z = Value::MakeBoolean(false);
...
TEST_CASE("Value::BitNot(Error)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::BitNot(location, x, &er);
  REQUIRE(y->IsError());
}
...
TEST_CASE("Value::BitNot(int8)") {
  ...
  REQUIRE(x->ConvertTo(&type::Int8::instance));
  ValuePtr y = Value::BitNot(location, x, &er);
  ValuePtr z = Value::MakeInteger(-4);
  REQUIRE(z->ConvertTo(&type::Int8::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::BitNot(uint8)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint8::instance));
  ValuePtr y = Value::BitNot(location, x, &er);
  ValuePtr z = Value::MakeInteger(252);
  REQUIRE(z->ConvertTo(&type::Uint8::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::BitNot(uint16)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint16::instance));
  ValuePtr y = Value::BitNot(location, x, &er);
  ValuePtr z = Value::MakeInteger(65532);
  REQUIRE(z->ConvertTo(&type::Uint16::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::BitNot(uint32)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint32::instance));
  ValuePtr y = Value::BitNot(location, x, &er);
  ValuePtr z = Value::MakeInteger(4294967292);
  REQUIRE(z->ConvertTo(&type::Uint32::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::BitNot(uint64)") {
  ...
  REQUIRE(x->ConvertTo(&type::Uint64::instance));
  ValuePtr y = Value::BitNot(location, x, &er);
  ValuePtr z = Value::MakeInteger(18446744073709551612ul);
  REQUIRE(z->ConvertTo(&type::Uint64::instance));
  REQUIRE(*y == *z);
}
...
TEST_CASE("Value::Multiply(Error, Error)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::Multiply(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::Multiply(Boolean, Boolean)") {
  ...
  ErrorReporter er(ss, 0, &abort_handler);
  ValuePtr x = Value::MakeBoolean(true);
  ValuePtr y = Value::MakeBoolean(true);
  ValuePtr z = Value::Multiply(location, x, y, &er);
  REQUIRE(z->IsError());
  REQUIRE(er.Count() == 1);
}
...
TEST_CASE("Value::Multiply(Integer, Integer)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(3);
  ValuePtr y = Value::MakeInteger(4);
  ValuePtr z = Value::Multiply(location, x, y, &er);
...
TEST_CASE("Value::Multiply(Float, Float)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeFloat(1.5);
  ValuePtr y = Value::MakeFloat(2.25);
  ValuePtr z = Value::Multiply(location, x, y, &er);
...
TEST_CASE("Value::Multiply(Complex, Complex)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(1, 2);
  ValuePtr y = Value::MakeComplex(3, 4);
  ValuePtr z = Value::Multiply(location, x, y, &er);
...
TEST_CASE("Value::Multiply(int8, int8)") {
  ...
  ValuePtr z = Value::Multiply(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(12);
...
TEST_CASE("Value::Multiply(complex64, complex64)") {
  ...
  ValuePtr z = Value::Multiply(location, x, y, &er);
  ValuePtr t = Value::MakeComplex(-5, 10);
...
TEST_CASE("Value::Divide(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::Divide(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::Divide(Float, Float)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeFloat(1);
  ValuePtr y = Value::MakeFloat(2);
  ValuePtr z = Value::Divide(location, x, y, &er);
...
TEST_CASE("Value::Divide(Complex, Complex)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(1, 0);
  ValuePtr y = Value::MakeComplex(0, 1);
  ValuePtr z = Value::Divide(location, x, y, &er);
...
TEST_CASE("Value::Divide(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::Divide(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Divide(complex64, complex64)") {
  ...
  REQUIRE(y->ConvertTo(&type::Complex64::instance));
  ValuePtr z = Value::Divide(location, x, y, &er);
  ValuePtr t = Value::MakeComplex(0, 1);
  REQUIRE(t->ConvertTo(&type::Complex64::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Divide(Integer, 0)") {
  ...
  ErrorReporter er(ss, 0, &abort_handler);
  ValuePtr x = Value::MakeInteger(3);
  ValuePtr y = Value::MakeInteger(0);
  ValuePtr z = Value::Divide(location, x, y, &er);
  REQUIRE(z->IsError());
  REQUIRE(er.Count() == 1);
}
...
TEST_CASE("Value::Modulo(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::Modulo(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::Modulo(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::Modulo(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(3);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::LeftShift(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::LeftShift(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::LeftShift(Integer, Complex)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(3);
  ValuePtr y = Value::MakeComplex(4, 0);
  ValuePtr z = Value::LeftShift(location, x, y, &er);
  REQUIRE(*z == *Value::MakeInteger(48));
}
...
TEST_CASE("Value::LeftShift(int8, Integer)") {
  ...
  ValuePtr y = Value::MakeInteger(4);
  ValuePtr z = Value::LeftShift(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(48);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::LeftShift(Complex, Integer)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(3, 0);
  ValuePtr y = Value::MakeInteger(4);
  ValuePtr z = Value::LeftShift(location, x, y, &er);
  REQUIRE(*z == *Value::MakeInteger(48));
}
...
TEST_CASE("Value::RightShift(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::RightShift(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::RightShift(Integer, Integer)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(48);
  ValuePtr y = Value::MakeInteger(4);
  ValuePtr z = Value::RightShift(location, x, y, &er);
  REQUIRE(*z == *Value::MakeInteger(3));
}
...
TEST_CASE("Value::RightShift(Complex, Integer)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(48, 0);
  ValuePtr y = Value::MakeInteger(4);
  ValuePtr z = Value::RightShift(location, x, y, &er);
  REQUIRE(*z == *Value::MakeInteger(3));
}
...
TEST_CASE("Value::BitAnd(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::BitAnd(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::BitAnd(Integer, Integer)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(10);
  ValuePtr y = Value::MakeInteger(-4);
  ValuePtr z = Value::BitAnd(location, x, y, &er);
...
TEST_CASE("Value::BitAnd(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::BitAnd(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(8);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitAnd(uint8, uint8)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(0x0A);
  REQUIRE(x->ConvertTo(&type::Uint8::instance));
  ValuePtr y = Value::MakeInteger(0xFC);
  REQUIRE(y->ConvertTo(&type::Uint8::instance));
  ValuePtr z = Value::BitAnd(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(8);
  REQUIRE(t->ConvertTo(&type::Uint8::instance));
...
TEST_CASE("Value::BitAnd(uint16, uint16)") {
  ...
  ValuePtr x = Value::MakeInteger(0x0A);
  REQUIRE(x->ConvertTo(&type::Uint16::instance));
  ValuePtr y = Value::MakeInteger(0xFFFC);
  REQUIRE(y->ConvertTo(&type::Uint16::instance));
  ValuePtr z = Value::BitAnd(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(8);
  REQUIRE(t->ConvertTo(&type::Uint16::instance));
...
TEST_CASE("Value::BitAnd(uint32, uint32)") {
  ...
  ValuePtr x = Value::MakeInteger(0x0A);
  REQUIRE(x->ConvertTo(&type::Uint32::instance));
  ValuePtr y = Value::MakeInteger(0xFFFFFFFC);
  REQUIRE(y->ConvertTo(&type::Uint32::instance));
  ValuePtr z = Value::BitAnd(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(8);
  REQUIRE(t->ConvertTo(&type::Uint32::instance));
...
TEST_CASE("Value::BitAnd(uint64, uint64)") {
  ...
  ValuePtr x = Value::MakeInteger(0x0A);
  REQUIRE(x->ConvertTo(&type::Uint64::instance));
  ValuePtr y = Value::MakeInteger(0xFFFFFFFFFFFFFFFC);
  REQUIRE(y->ConvertTo(&type::Uint64::instance));
  ValuePtr z = Value::BitAnd(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(8);
  REQUIRE(t->ConvertTo(&type::Uint64::instance));
...
TEST_CASE("Value::BitAndNot(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::BitAndNot(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::BitAndNot(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::BitAndNot(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(2);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Add(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::Add(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::Add(String, String)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeString("hello ");
  ValuePtr y = Value::MakeString("world");
  ValuePtr z = Value::Add(location, x, y, &er);
...
TEST_CASE("Value::Add(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::Add(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(7);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Add(complex64, complex64)") {
  ...
  REQUIRE(y->ConvertTo(&type::Complex64::instance));
  ValuePtr z = Value::Add(location, x, y, &er);
  ValuePtr t = Value::MakeComplex(4, 6);
  REQUIRE(t->ConvertTo(&type::Complex64::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Add(string, string)") {
  ...
  ValuePtr z = Value::Add(location, x, y, &er);
  ValuePtr t = Value::MakeString("hello world");
...
TEST_CASE("Value::Subtract(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::Subtract(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::Subtract(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::Subtract(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(-1);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Subtract(uint8, uint8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint8::instance));
  ValuePtr z = Value::Subtract(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(255);
  REQUIRE(t->ConvertTo(&type::Uint8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Subtract(uint16, uint16)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint16::instance));
  ValuePtr z = Value::Subtract(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(65535);
  REQUIRE(t->ConvertTo(&type::Uint16::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Subtract(uint32, uint32)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint32::instance));
  ValuePtr z = Value::Subtract(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(4294967295);
  REQUIRE(t->ConvertTo(&type::Uint32::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Subtract(uint64, uint64)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint64::instance));
  ValuePtr z = Value::Subtract(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(18446744073709551615UL);
  REQUIRE(t->ConvertTo(&type::Uint64::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Subtract(complex64, complex64)") {
  ...
  REQUIRE(y->ConvertTo(&type::Complex64::instance));
  ValuePtr z = Value::Subtract(location, x, y, &er);
  ValuePtr t = Value::MakeComplex(-2, -2);
  REQUIRE(t->ConvertTo(&type::Complex64::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitOr(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::BitOr(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::BitOr(uint8, uint8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint8::instance));
  ValuePtr z = Value::BitOr(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFE);
  REQUIRE(t->ConvertTo(&type::Uint8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitOr(uint16, uint16)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint16::instance));
  ValuePtr z = Value::BitOr(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFFFE);
  REQUIRE(t->ConvertTo(&type::Uint16::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitOr(uint32, uint32)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint32::instance));
  ValuePtr z = Value::BitOr(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFFFFFFFE);
  REQUIRE(t->ConvertTo(&type::Uint32::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitOr(uint64, uint64)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint64::instance));
  ValuePtr z = Value::BitOr(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFFFFFFFFFFFFFFFE);
  REQUIRE(t->ConvertTo(&type::Uint64::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitXor(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::BitXor(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::BitXor(int8, int8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Int8::instance));
  ValuePtr z = Value::BitXor(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(-10);
  REQUIRE(t->ConvertTo(&type::Int8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitXor(uint8, uint8)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint8::instance));
  ValuePtr z = Value::BitXor(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xF6);
  REQUIRE(t->ConvertTo(&type::Uint8::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitXor(uint16, uint16)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint16::instance));
  ValuePtr z = Value::BitXor(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFFF6);
  REQUIRE(t->ConvertTo(&type::Uint16::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitXor(uint32, uint32)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint32::instance));
  ValuePtr z = Value::BitXor(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFFFFFFF6);
  REQUIRE(t->ConvertTo(&type::Uint32::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::BitXor(uint64, uint64)") {
  ...
  REQUIRE(y->ConvertTo(&type::Uint64::instance));
  ValuePtr z = Value::BitXor(location, x, y, &er);
  ValuePtr t = Value::MakeInteger(0xFFFFFFFFFFFFFFF6);
  REQUIRE(t->ConvertTo(&type::Uint64::instance));
  REQUIRE(*z == *t);
}
...
TEST_CASE("Value::Equal(Error, Error)") {
  ...
  ValuePtr x = Value::MakeError();
  ValuePtr y = Value::MakeError();
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(z->IsError());
}
...
TEST_CASE("Value::Equal(true, false)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeBoolean(true);
  ValuePtr y = Value::MakeBoolean(false);
  ValuePtr z = Value::Equal(location, x, y, &er);
...
TEST_CASE("Value::Equal(Integer, Bool)") {
  std::stringstream ss;
  ErrorReporter er(ss, 0, &abort_handler);
  ValuePtr x = Value::MakeInteger(0);
  ValuePtr y = Value::MakeBoolean(true);
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(z->IsError());
  REQUIRE(er.Count() == 1);
...
TEST_CASE("Value::Equal(Float, Float)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeFloat(3);
  ValuePtr y = Value::MakeFloat(3.5);
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(false));
}
...
TEST_CASE("Value::Equal(Complex, Complex)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeComplex(3.5, 4);
  ValuePtr y = Value::MakeComplex(3.5, 4);
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(true));
}
...
TEST_CASE("Value::Equal(String, String)") {
  ...
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeString("hello");
  ValuePtr y = Value::MakeString("hello, world");
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(false));
}
...
TEST_CASE("Value::Equal(bool, bool)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeBoolean(false);
  REQUIRE(x->ConvertTo(&type::Bool::instance));
  ValuePtr y = Value::MakeBoolean(false);
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(true));
...
TEST_CASE("Value::Equal(complex128, complex128)") {
  ...
  ValuePtr x = Value::MakeComplex(1, 2);
  REQUIRE(x->ConvertTo(&type::Complex128::instance));
  ValuePtr y = Value::MakeComplex(1, 2);
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(true));
}
...
TEST_CASE("Value::Equal(int, int)") {
  std::stringstream ss;
  ErrorReporter er(ss, 1, &abort_handler);
  ValuePtr x = Value::MakeInteger(1);
  ValuePtr y = Value::MakeInteger(3);
  REQUIRE(y->ConvertTo(&type::Int::instance));
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(false));
}
...
TEST_CASE("Value::Equal(int8, int8)") {
  ...
  ValuePtr x = Value::MakeInteger(1);
  REQUIRE(x->ConvertTo(&type::Int8::instance));
  ValuePtr y = Value::MakeInteger(1);
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(true));
}
...
TEST_CASE("Value::Equal(string, string)") {
  ...
  ValuePtr x = Value::MakeString("hello");
  REQUIRE(x->ConvertTo(&type::String::instance));
  ValuePtr y = Value::MakeString("hello");
  ValuePtr z = Value::Equal(location, x, y, &er);
  REQUIRE(*z == *Value::MakeBoolean(true));
}
...
TEST_CASE("operator<<(Rune)") {
  {
    std::stringstream ss;
    ValuePtr x = Value::MakeRune('j');
    ss << *x;
    REQUIRE(ss.str() == "'j'");
  }
  {
    std::stringstream ss;
    ValuePtr x = Value::MakeRune(INVALID);
    ss << *x;
    REQUIRE(ss.str() == "1114112");
  }
  {
    std::stringstream ss;
    ValuePtr x = Value::MakeRune(SURROGATE_FIRST);
    ss << *x;
...
TEST_CASE("operator<<(Float)") {
  std::stringstream ss;
  ValuePtr x = Value::MakeFloat(34.5);
  ss << *x;
  REQUIRE(ss.str() == "34.5");
}
