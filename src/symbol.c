...
symbol_t* symbol_make_undefined (string_t identifier, SymbolKind kind, ast_t* defining_node)
{
  switch (kind)
    ...
    case SymbolVariable:
      unimplemented;
    case SymbolType:
      return symbol_make_type (identifier, type_make_undefined (), defining_node);
    }
...
symbol_t *
symbol_make_typed_constant (string_t identifier, typed_value_t value, ast_t* defining_node)
{
...
symbol_t *
symbol_make_untyped_constant (string_t identifier, untyped_value_t value, ast_t* defining_node)
{
...
symbol_t *
symbol_make_instance (string_t identifier, const type_t * type, ast_t* defining_node)
{
