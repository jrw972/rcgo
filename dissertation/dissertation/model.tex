...
\draw[thick,->,dashed] (trans1) -- (apushin1.center);
\draw[thick,->,dashed] (trans1) -- (apushin2.center);
\node at(7.5,4) {\textbf{activate}};
\draw[thick,->,dashed] (trans2) -- (apushin2.center);
\draw[thick,->,dashed] (trans2) -- (apushin3.center);
%% passive push ports
\lppush[0,5,1,.5,ppushex1,ppushin1]{}
\draw[thick,->] (ppushin1.center) -- (trans2);
