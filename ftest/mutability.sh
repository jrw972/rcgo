...
expect_error   4  "mutable mutable = mutable immutable *int"     mutability_mm_a_mip.rc E161
expect_success 5  "mutable mutable = mutable foreign int"        mutability_mm_a_mfs.rc
expect_error   6  "mutable mutable = mutable foreign *int"       mutability_mm_a_mfp.rc E161
...
expect_error   10 "mutable mutable = immutable immutable *int"   mutability_mm_a_iip.rc E161
expect_success 11 "mutable mutable = immutable foreign int"      mutability_mm_a_ifs.rc
expect_error   12 "mutable mutable = immutable foreign *int"     mutability_mm_a_ifp.rc E161
...
expect_error   16 "mutable mutable = foreign immutable *int"     mutability_mm_a_fip.rc E161
expect_success 17 "mutable mutable = foreign foreign int"        mutability_mm_a_ffs.rc
expect_error   18 "mutable mutable = foreign foreign *int"       mutability_mm_a_ffp.rc E161
...
expect_error   24 "mutable immutable = mutable foreign *int"     mutability_mi_a_mfp.rc E161
...
expect_error   30 "mutable immutable = immutable foreign *int"   mutability_mi_a_ifp.rc E161
...
expect_error   36 "mutable immutable = foreign foreign *int"     mutability_mi_a_ffp.rc E161
...
expect_error   61 "mutable mutable = *(mutable immutable)"       mutability_a_dmi.rc E161
expect_error   62 "mutable mutable = *(mutable foreign)"         mutability_a_dmf.rc E161

expect_success 63 "mutable mutable = &(mutable mutable)"         mutability_a_rmm.rc
expect_error   64 "mutable mutable = &(immutable mutable)"       mutability_a_rim.rc E161
expect_error   65 "mutable mutable = &(foreign mutable)"         mutability_a_rfm.rc E161

expect_error   66 "mutable mutable = &(mutable immutable)"       mutability_a_rmi.rc E161
expect_error   67 "mutable mutable = &(immutable immutable)"     mutability_a_rii.rc E161
expect_error   68 "mutable mutable = &(foreign immutable)"       mutability_a_rfi.rc E161

expect_error   69 "mutable immutable = &(mutable foreign)"       mutability_a_rmf.rc E161
expect_error   70 "mutable immutable = &(immutable foreign)"     mutability_a_rif.rc E161
expect_error   71 "mutable immutable = &(foreign foreign)"       mutability_a_rff.rc E161
...
expect_error   76 "mutable mutable = (mutable immutable)."       mutability_a_mis.rc E161
expect_error   77 "mutable mutable = (mutable foreign)."         mutability_a_mfs.rc E161
...
expect_error   82 "mutable mutable = (mutable immutable)[]"      mutability_a_mii.rc E161
expect_error   83 "mutable mutable = (mutable foreign)[]"        mutability_a_mfi.rc E161

expect_error   84 "pointer in struct"                            mutability_pis.rc E161
